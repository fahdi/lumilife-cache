    ...
    function meta_box($object, $box) {
        ...
        <div class="woocommerce_options_panel">
                ...
                <div class="options_group">
                    ...
                    <div id="wc_catalog_restrictions_locations_container" class="wc_restrictions_options_panel" style="<?php echo (get_post_meta($object->ID, '_wc_restrictions_location', true) == 'restricted' ? 'display:block;' : 'display:none;'); ?>">
                        ...
                        <select name="wc_restrictions_locations[]" class="wc_restrictions_chosen_select" multiple="multiple" data-placeholder="<?php _e('Search for a country&hellip;', 'woocommerce'); ?>">
                            ...
                            ?>
                        </select> <img class="help_tip" data-tip='<?php _e('Choose locations for this product.  Only users who select a matching location will be able to view and purchase this product.', 'woocommerce') ?>' src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" />
                    </div>
                </div>
            <?php endif; ?>
            ...
            woocommerce_wp_select(array('id' => '_wc_restrictions', 'label' => __('Who can view this product', 'wc_catalog_restrictions'), 'options' => array(
                ...
                ), 'std' => 'inherit', 'desc_tip' => true, 'description' => __('If you would like to only show this product to users who are in certian roles select "Specific Roles"')
            ));
            ?>
