...
global $woocommerce, $product, $yith_wcwl, $post, $catalog_mode;
	...
	<?php if ( ! empty( $available_variations ) ) : ?>
		...
		<div class="single_variation_wrap" style="display:none;">
			...
			<div class="variations_button">
				...
				<?php 
					$button_text = '<i class="fa-plus"></i>' . apply_filters('single_add_to_cart_text', __("Add to shopping bag", "swiftframework"), $product->product_type);
				?>	
