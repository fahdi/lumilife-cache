		...
		<ul class="slides">
			<?php
				if ( has_post_thumbnail() ) {
					...
					echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<li itemprop="image">%s<a href="%s" itemprop="image" class="woocommerce-main-image zoom" title="%s"  rel="prettyPhoto[product-gallery]"><i class="fa-expand"></i></a></li>', $image_html, $image_link, $image_title ), $post->ID );	
					...
					if ( $attachment_ids ) {
						...
						foreach ( $attachment_ids as $attachment_id ) {
							...
							if ($image) {
								...
								echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<li>%s<a href="%s" class="%s" title="%s"  rel="prettyPhoto[product-gallery]"><i class="fa-expand"></i></a></li>', $image_html, $image_link, $image_class, $image_title ), $attachment_id, $post->ID, $image_class );
